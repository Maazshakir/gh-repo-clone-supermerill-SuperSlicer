...
extern const char* const MSG_AUTOLOADING_ENABLED_LANG_TABLE[1];
#define MSG_AUTOLOADING_ENABLED LANG_TABLE_SELECT_EXPLICIT(MSG_AUTOLOADING_ENABLED_LANG_TABLE, 0)
extern const char* const MSG_AUTOLOADING_ONLY_IF_FSENS_ON_LANG_TABLE[1];
#define MSG_AUTOLOADING_ONLY_IF_FSENS_ON LANG_TABLE_SELECT_EXPLICIT(MSG_AUTOLOADING_ONLY_IF_FSENS_ON_LANG_TABLE, 0)
...
extern const char* const MSG_CHECK_IDLER_LANG_TABLE[1];
#define MSG_CHECK_IDLER LANG_TABLE_SELECT_EXPLICIT(MSG_CHECK_IDLER_LANG_TABLE, 0)
...
extern const char* const MSG_CRASH_DETECTED2_LANG_TABLE[1];
#define MSG_CRASH_DETECTED2 LANG_TABLE_SELECT_EXPLICIT(MSG_CRASH_DETECTED2_LANG_TABLE, 0)
extern const char* const MSG_CRASH_DET_ONLY_IN_NORMAL_LANG_TABLE[1];
#define MSG_CRASH_DET_ONLY_IN_NORMAL LANG_TABLE_SELECT_EXPLICIT(MSG_CRASH_DET_ONLY_IN_NORMAL_LANG_TABLE, 0)
extern const char* const MSG_CRASH_DET_STEALTH_FORCE_OFF_LANG_TABLE[1];
#define MSG_CRASH_DET_STEALTH_FORCE_OFF LANG_TABLE_SELECT_EXPLICIT(MSG_CRASH_DET_STEALTH_FORCE_OFF_LANG_TABLE, 0)
extern const char* const MSG_CURRENT_LANG_TABLE[LANG_NUM];
#define MSG_CURRENT LANG_TABLE_SELECT(MSG_CURRENT_LANG_TABLE)
extern const char* const MSG_DATE_LANG_TABLE[1];
#define MSG_DATE LANG_TABLE_SELECT_EXPLICIT(MSG_DATE_LANG_TABLE, 0)
...
#define MSG_FSENSOR_NA LANG_TABLE_SELECT_EXPLICIT(MSG_FSENSOR_NA_LANG_TABLE, 0)
...
extern const char* const MSG_FSENS_AUTOLOAD_NA_LANG_TABLE[1];
#define MSG_FSENS_AUTOLOAD_NA LANG_TABLE_SELECT_EXPLICIT(MSG_FSENS_AUTOLOAD_NA_LANG_TABLE, 0)
...
extern const char* const MSG_FSENS_NOT_RESPONDING_LANG_TABLE[1];
#define MSG_FSENS_NOT_RESPONDING LANG_TABLE_SELECT_EXPLICIT(MSG_FSENS_NOT_RESPONDING_LANG_TABLE, 0)
extern const char* const MSG_FW_VERSION_ALPHA_LANG_TABLE[1];
#define MSG_FW_VERSION_ALPHA LANG_TABLE_SELECT_EXPLICIT(MSG_FW_VERSION_ALPHA_LANG_TABLE, 0)
extern const char* const MSG_FW_VERSION_BETA_LANG_TABLE[1];
#define MSG_FW_VERSION_BETA LANG_TABLE_SELECT_EXPLICIT(MSG_FW_VERSION_BETA_LANG_TABLE, 0)
extern const char* const MSG_FW_VERSION_RC_LANG_TABLE[1];
#define MSG_FW_VERSION_RC LANG_TABLE_SELECT_EXPLICIT(MSG_FW_VERSION_RC_LANG_TABLE, 0)
extern const char* const MSG_FW_VERSION_UNKNOWN_LANG_TABLE[1];
#define MSG_FW_VERSION_UNKNOWN LANG_TABLE_SELECT_EXPLICIT(MSG_FW_VERSION_UNKNOWN_LANG_TABLE, 0)
...
extern const char* const MSG_LEFT_LANG_TABLE[1];
#define MSG_LEFT LANG_TABLE_SELECT_EXPLICIT(MSG_LEFT_LANG_TABLE, 0)
...
extern const char* const MSG_M117_V2_CALIBRATION_LANG_TABLE[1];
#define MSG_M117_V2_CALIBRATION LANG_TABLE_SELECT_EXPLICIT(MSG_M117_V2_CALIBRATION_LANG_TABLE, 0)
...
extern const char* const MSG_MEASURED_SKEW_LANG_TABLE[1];
#define MSG_MEASURED_SKEW LANG_TABLE_SELECT_EXPLICIT(MSG_MEASURED_SKEW_LANG_TABLE, 0)
...
extern const char* const MSG_MENU_BELT_STATUS_LANG_TABLE[1];
#define MSG_MENU_BELT_STATUS LANG_TABLE_SELECT_EXPLICIT(MSG_MENU_BELT_STATUS_LANG_TABLE, 0)
...
extern const char* const MSG_MENU_TEMPERATURES_LANG_TABLE[1];
#define MSG_MENU_TEMPERATURES LANG_TABLE_SELECT_EXPLICIT(MSG_MENU_TEMPERATURES_LANG_TABLE, 0)
extern const char* const MSG_MENU_VOLTAGES_LANG_TABLE[1];
#define MSG_MENU_VOLTAGES LANG_TABLE_SELECT_EXPLICIT(MSG_MENU_VOLTAGES_LANG_TABLE, 0)
...
extern const char* const MSG_PRESS_TO_PREHEAT_LANG_TABLE[1];
#define MSG_PRESS_TO_PREHEAT LANG_TABLE_SELECT_EXPLICIT(MSG_PRESS_TO_PREHEAT_LANG_TABLE, 0)
extern const char* const MSG_PRESS_TO_UNLOAD_LANG_TABLE[1];
#define MSG_PRESS_TO_UNLOAD LANG_TABLE_SELECT_EXPLICIT(MSG_PRESS_TO_UNLOAD_LANG_TABLE, 0)
...
extern const char* const MSG_PULL_OUT_FILAMENT_LANG_TABLE[1];
#define MSG_PULL_OUT_FILAMENT LANG_TABLE_SELECT_EXPLICIT(MSG_PULL_OUT_FILAMENT_LANG_TABLE, 0)
...
extern const char* const MSG_RIGHT_LANG_TABLE[1];
#define MSG_RIGHT LANG_TABLE_SELECT_EXPLICIT(MSG_RIGHT_LANG_TABLE, 0)
...
extern const char* const MSG_SEVERE_SKEW_LANG_TABLE[1];
#define MSG_SEVERE_SKEW LANG_TABLE_SELECT_EXPLICIT(MSG_SEVERE_SKEW_LANG_TABLE, 0)
...
extern const char* const MSG_SLIGHT_SKEW_LANG_TABLE[1];
#define MSG_SLIGHT_SKEW LANG_TABLE_SELECT_EXPLICIT(MSG_SLIGHT_SKEW_LANG_TABLE, 0)
...
extern const char* const MSG_UNLOAD_SUCCESSFUL_LANG_TABLE[1];
#define MSG_UNLOAD_SUCCESSFUL LANG_TABLE_SELECT_EXPLICIT(MSG_UNLOAD_SUCCESSFUL_LANG_TABLE, 0)
...
extern const char* const MSG_XYZ_DETAILS_LANG_TABLE[1];
#define MSG_XYZ_DETAILS LANG_TABLE_SELECT_EXPLICIT(MSG_XYZ_DETAILS_LANG_TABLE, 0)
...
extern const char* const MSG_Y_DISTANCE_FROM_MIN_LANG_TABLE[1];
#define MSG_Y_DISTANCE_FROM_MIN LANG_TABLE_SELECT_EXPLICIT(MSG_Y_DISTANCE_FROM_MIN_LANG_TABLE, 0)
