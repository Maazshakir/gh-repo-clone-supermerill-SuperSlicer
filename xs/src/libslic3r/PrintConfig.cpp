...
PrintConfigDef::PrintConfigDef()
{
    ...
    def->label = "Number of dense layers";
    def->category = "Infill";
    def->tooltip = "Set the number of denser infill layer you want between the normal sparse infill and the top layers. 0 to disable";
    def->sidetext = "layers";
    ...
    def->label = "angle";
    def->category = "Infill";
    def->tooltip = "Set the Angle of dense infill.";
    def->sidetext = "layers";
    ...
    def->gui_type = "f_enum_open";
    def->gui_flags = "show_value";
    def->label = "Dense fill density";
    def->category = "Infill";
    def->tooltip = "Density of the dense internal infill, expressed in the range 0% - 100%.";
    def->sidetext = "%";
    ...
    def = this->add("infill_dense_pattern", external_fill_pattern);
    def->label = "pattern";
    def->category = "Sparse fill pattern";
    def->tooltip = "Fill pattern for denser-density sparse infill.";
